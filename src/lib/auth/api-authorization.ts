...
export const API_AUTHORIZATION = {
  ...
  "api:PATCH:/api/restaurant": membership("restaurant:manage"),
  ...
  "api:GET:/api/scans/{param}": membership("scan:create"),
  ...
  "api:POST:/api/team": membership("team:invite-manage"),
  "api:DELETE:/api/team/{param}": membership("team:member-manage"),
  ...
  "api:GET:/api/wines/{param}": membership("wine:view"),
