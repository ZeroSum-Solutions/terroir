...
export function OverpaidFlagButton({
  ...
  return (
    React.createElement("button", {
      ...
      className: "inline-flex min-h-11 min-w-11 items-center justify-center rounded-pill p-xs transition-colors " + (flagged ? "text-risk-ink bg-risk-wash hover:bg-risk-wash" : "text-grey hover:text-risk-ink hover:bg-risk-wash/60"),
    },
