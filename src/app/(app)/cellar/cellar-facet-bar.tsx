...
export function CellarFacetBar({
  ...
  return (
    <div
      ...
      className="mb-md flex max-w-full flex-wrap items-center gap-xs rounded-md border border-hairline bg-white p-xs"
    >
      <FacetSelect
        label="Producer"
      ...
      {hasFacets && (
        <button
          ...
          className="h-11 shrink-0 rounded-pill px-sm text-[12px] font-medium text-grey hover:bg-bridge-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/25"
        >
          Clear facets
        </button>
      )}
