...
export function ExportCsvButton({ rows }: { rows: ScanHistoryCsvRow[] }) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="flex h-8 items-center justify-center gap-xs rounded-pill border border-border-strong bg-white px-md text-[12px] font-medium text-ink hover:bg-surface-muted focus-visible:ring-2 focus-visible:ring-accent-soft focus-visible:ring-offset-2"
