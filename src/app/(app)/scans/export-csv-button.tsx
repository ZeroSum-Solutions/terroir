...
export function ExportCsvButton({ rows }: { rows: ScanHistoryCsvRow[] }) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="flex h-8 items-center justify-center gap-xs rounded-pill border border-ink/25 bg-white px-md text-[12px] font-medium text-ink hover:bg-bridge-surface focus-visible:ring-2 focus-visible:ring-blush-wash focus-visible:ring-offset-2"
