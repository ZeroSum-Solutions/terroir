...
export function ReconcileQueueMetric() {
  ...
  return (
    <div data-metric="reconcile-queue-count" className="mb-lg md:mb-xl">
      <Link href="/reconcile-queue" className="group flex min-h-11 items-center justify-between gap-md rounded-card card-surface px-md py-sm transition-colors hover:bg-beige focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/25">
