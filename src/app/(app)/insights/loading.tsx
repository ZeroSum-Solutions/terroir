  ...
  return (
    <div className="space-y-xl">
      <div className="dawn-gradient rounded-card px-lg py-xl md:px-2xl md:py-2xl">
        <Skeleton className="h-[12px] w-24 mb-sm bg-surface/40" />
        <Skeleton className="h-[44px] w-64 mb-md bg-surface/40" />
        <Skeleton className="h-[16px] w-80 max-w-full bg-surface/40" />
