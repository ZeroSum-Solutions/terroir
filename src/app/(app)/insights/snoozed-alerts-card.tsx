  ...
  return (
    <article className="rounded-card border border-hairline bg-white p-md md:p-lg">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        aria-expanded={open}
        className="flex w-full items-center justify-between rounded-sm text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/25"
      >
        <div>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="inline-flex h-[30px] items-center gap-2xs rounded-pill border border-ink/25 bg-white px-sm text-[12px] font-medium text-ink hover:bg-bridge-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/25 disabled:opacity-60"
                >
                  <RotateCcw
                    className="h-3 w-3"
                    strokeWidth={2}
