...
/**
 * Exchanges the token hash in the dedicated password-recovery email template.
 * Only recovery is accepted: this route cannot be repurposed as a generic
 * session minting endpoint by supplying another OTP type or redirect target.
 */
